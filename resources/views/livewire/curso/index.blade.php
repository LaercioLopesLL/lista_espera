<div>
            ...
            <table class="text-left w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="py-3 px-6 font-bold uppercase text-sm text-gray-600 border-b-2">Curso</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100 border-b">
                        <td class="py-2 px-6 border-grey-light">{{ $curso->id }}</td>
                        <td class="py-2 px-6 border-grey-light">{{ $curso->nome }}</td>
                        <td class="py-2 px-6 border-grey-light">{{ $curso->created_at }}</td>
                        <td>
                            <x-jet-danger-button class="sm:py-2 sm:px-2" wire:click="confirmDelete({{ $curso->id }})"
    ...
    <x-jet-confirmation-modal wire:model="confirmingDeletion">
        <x-slot name="title">
            <span class="font-bold text-gray-600">Excluir Curso</span>
        </x-slot>

        <x-slot name="content">
            <span class="text-gray-600">Confirma a exclusão do curso abaixo?</span>
            <table class="text-left w-full border-collapse">
                <thead>
                    <tr>
                        <th class="py-3 px-6 font-bold text-sm text-gray-600">ID</th>
                        <th class="py-3 px-6 font-bold text-sm text-gray-600">Curso</th>
                    </tr>
                </thead>
                <tbody>
